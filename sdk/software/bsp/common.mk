...
HAS_CACHE ?= 1
CACHE_INDEX_DEPTH ?= 0x100
CACHE_OFFSET_WIDTH ?= 0x4
CACHE_WAY ?= 2

CFLAGS += -Dhas_cache=$(HAS_CACHE)
CFLAGS += -Dcache_index_depth=$(CACHE_INDEX_DEPTH) -Dcache_offset_width=$(CACHE_OFFSET_WIDTH) -Dcache_way=$(CACHE_WAY)
