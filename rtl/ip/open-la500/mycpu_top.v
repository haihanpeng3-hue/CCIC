...
wire         ms_dcache_miss;
wire         disable_cache;
wire         perf_counter_clear;
wire [31:0]  perf_commit_inst_counter;
wire [31:0]  perf_icache_miss_counter;
wire [31:0]  perf_dcache_miss_counter;
wire [31:0]  perf_mem_inst_counter;
wire [31:0]  perf_br_inst_counter;
wire [31:0]  perf_br_pre_counter;
wire [31:0]  perf_br_pre_error_counter;
...
`ifdef HAS_LACC
wire         es_lacc_req;
wire [`LACC_OP_WIDTH-1: 0] es_lacc_command;
wire [31:0]  lacc_req_rj;
wire [31:0]  lacc_req_rk;
wire         lacc_rsp_valid;
wire [31:0]  lacc_rsp_rdat;
wire         lacc_data_valid;
wire [31:0]  lacc_data_addr;
wire         lacc_data_read;
wire [31:0]  lacc_data_wdata;
wire [ 2:0]  lacc_data_size;
wire         lacc_drsp_valid;
wire [31:0]  lacc_drsp_rdata;
wire [6: 0]  lacc_req_imm;
wire         lacc_flush;
`endif
...
`ifdef HAS_LACC
    .es_lacc_req          (es_lacc_req         ),
    .es_lacc_command      (es_lacc_command     ),
...
lacc_core u_lacc_core(
    ...
    .lacc_req_valid  (es_lacc_req    ),
    .lacc_req_command(es_lacc_command),
    .lacc_req_rj     (es_rj_value    ),
    .lacc_req_rk     (es_rkd_value   ),
    .lacc_req_imm    (lacc_req_imm   ),
...
perf_counter u_perf_counter(
    ...
    .dcache_miss_counter  (perf_dcache_miss_counter),
    .icache_miss_counter  (perf_icache_miss_counter),
    .commit_inst_counter  (perf_commit_inst_counter),
    .br_inst_counter      (perf_br_inst_counter    ),
    .mem_inst_counter     (perf_mem_inst_counter   ),
    .br_pre_counter       (perf_br_pre_counter     ),
    .br_pre_error_counter (perf_br_pre_error_counter)
);
...
csr #(TLBNUM) u_csr(
    ...
    .perf_counter_clear_out (perf_counter_clear),
    .perf_commit_inst_in (perf_commit_inst_counter ),
    .perf_icache_miss_in (perf_icache_miss_counter ),
    .perf_dcache_miss_in (perf_dcache_miss_counter ),
    .perf_mem_inst_in    (perf_mem_inst_counter    ),
    .perf_br_inst_in     (perf_br_inst_counter     ),
    .perf_br_pre_in      (perf_br_pre_counter      ),
    .perf_br_pre_error_in(perf_br_pre_error_counter),
    //to addr trans
    .asid_out       (csr_asid        ),
