...
reg  [31:0] fs_pc;
    ...
    reg [38:0] btb_lock_buffer;
reg        btb_lock_en;

assign fs_to_ds_bus = {btb_ret_pc_t,    //109:78
                       btb_index_t,     //77:72
                       btb_taken_t,     //71:71
                       btb_en_t,        //70:70
                       icache_miss,     //69:69
...
assign fetch_btb_target = (btb_taken && btb_en) || (btb_lock_en && btb_lock_buffer[38]);
...
assign btb_index_t  = {6{btb_lock_en}} & btb_lock_buffer[37:32] | btb_index;
assign btb_taken_t  = btb_lock_en && btb_lock_buffer[38] || btb_taken;
