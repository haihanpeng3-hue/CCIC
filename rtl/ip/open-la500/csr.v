...
(
    ...
    output                          perf_counter_clear_out,
    input  [31:0]                   perf_commit_inst_in,
    input  [31:0]                   perf_icache_miss_in,
    input  [31:0]                   perf_dcache_miss_in,
    input  [31:0]                   perf_mem_inst_in,
    input  [31:0]                   perf_br_inst_in,
    input  [31:0]                   perf_br_pre_in,
    input  [31:0]                   perf_br_pre_error_in,
    //to addr trans
    output [ 9:0]                   asid_out     ,
...
localparam PERF_COMMIT_INST  = 14'h102;
localparam PERF_ICACHE_MISS  = 14'h103;
localparam PERF_DCACHE_MISS  = 14'h104;
localparam PERF_MEM_INST     = 14'h105;
localparam PERF_BR_INST      = 14'h106;
localparam PERF_BR_PRE       = 14'h107;
localparam PERF_BR_PRE_ERROR = 14'h108;
localparam PERF_CTRL         = 14'h109;
...
assign perf_counter_clear_out = csr_wr_en && (wr_addr == PERF_CTRL) && wr_data[0];
...
assign rd_data = {32{rd_addr == CRMD  }}  & csr_crmd    |
                 ...
                 {32{rd_addr == TLBRENTRY}} & csr_tlbrentry   |
                  ...
                  {32{rd_addr == PERF_COMMIT_INST }}  & perf_commit_inst_in   |
                  {32{rd_addr == PERF_ICACHE_MISS }}  & perf_icache_miss_in   |
                  {32{rd_addr == PERF_DCACHE_MISS }}  & perf_dcache_miss_in   |
                  {32{rd_addr == PERF_MEM_INST    }}  & perf_mem_inst_in      |
                  {32{rd_addr == PERF_BR_INST     }}  & perf_br_inst_in       |
                  {32{rd_addr == PERF_BR_PRE      }}  & perf_br_pre_in        |
                  {32{rd_addr == PERF_BR_PRE_ERROR}}  & perf_br_pre_error_in  |
                  {32{rd_addr == PERF_CTRL        }}  & 32'b0                 |
