module perf_counter (
    ...
    input      br_pre           ,
    input      br_pre_error     ,
    output reg [31:0] dcache_miss_counter,
    output reg [31:0] icache_miss_counter,
    output reg [31:0] commit_inst_counter,
    output reg [31:0] br_inst_counter,
    output reg [31:0] mem_inst_counter,
    output reg [31:0] br_pre_counter,
    output reg [31:0] br_pre_error_counter
);
